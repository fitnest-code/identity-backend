...
import az.fitnest.identity.otp.api.dto.response.OtpVerifyResponse;
...
import az.fitnest.identity.shared.exception.OtpRateLimitedException;
...
import az.fitnest.identity.user.adapter.service.EmailNormalizationService;
...
import az.fitnest.identity.otp.adapter.service.OtpGenerator;
import az.fitnest.identity.otp.adapter.service.OtpSessionIdGenerator;
...
import az.fitnest.identity.auth.adapter.service.RegistrationTokenService;
import az.fitnest.identity.auth.adapter.service.ResetPasswordTokenService;
...
public class OtpService {
    ...
    public OtpSendResponse sendOtp(OtpSendRequest request, String firstName, String lastName, String userPasswordHash, String mobile) {
        ...
        String mobileNumber = az.fitnest.identity.shared.util.MobileNumberUtils.normalize(rawMobile);
