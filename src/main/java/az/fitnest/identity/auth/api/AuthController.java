package az.fitnest.identity.auth.api;

import az.fitnest.identity.auth.adapter.service.AuthService;
import az.fitnest.identity.auth.adapter.service.SocialAuthService;
import az.fitnest.identity.auth.adapter.service.PasswordResetService;
import az.fitnest.identity.auth.adapter.service.RegistrationService;
import az.fitnest.identity.auth.api.dto.request.AppleSocialRequest;
import az.fitnest.identity.auth.api.dto.request.GoogleSocialRequest;
import az.fitnest.identity.auth.api.dto.request.LoginRequest;
import az.fitnest.identity.auth.api.dto.request.ForgotPasswordRequest;
import az.fitnest.identity.auth.api.dto.request.RefreshRequest;
...
import az.fitnest.identity.auth.api.dto.response.RefreshResponse;
...
import az.fitnest.identity.shared.exception.UnauthorizedException;
