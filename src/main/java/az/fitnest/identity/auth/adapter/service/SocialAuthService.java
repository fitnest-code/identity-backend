...
import az.fitnest.identity.auth.adapter.persistence.SocialAuthRepository;
...
public class SocialAuthService {
    ...
    private final az.fitnest.identity.user.adapter.persistence.RoleRepository roleRepository;
    ...
    private User createUserForSocialLogin(String firstName, String lastName, String fullName, String mobile) {
        ...
        User user = User.builder()
                ...
                .isDeleted(false)
                .role(roleRepository.findByName(az.fitnest.identity.user.domain.enums.RoleName.ROLE_USER).orElse(null))
                .build();
