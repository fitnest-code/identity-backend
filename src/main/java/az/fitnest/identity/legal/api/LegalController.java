package az.fitnest.identity.legal.api;

import az.fitnest.identity.legal.adapter.service.LegalService;
...
public class LegalController {
    ...
    private Long getCurrentUserId() {
        ...
        if (authentication == null || !(authentication.getPrincipal() instanceof Long)) {
            ...
            throw new az.fitnest.identity.shared.exception.UnauthorizedException("User not authenticated");
        }
