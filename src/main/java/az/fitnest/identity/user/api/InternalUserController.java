package az.fitnest.identity.user.api;
...
import az.fitnest.identity.user.api.dto.request.UpdateProfileImageRequest;
import az.fitnest.identity.user.api.dto.request.UpdateSetupRequiredRequest;
import az.fitnest.identity.user.api.dto.request.UpdateUserProfileRequest;
 ...
 * <ul>
 *   <li><strong>user-service</strong> - Uses IdentityServiceClient to call these endpoints for:
 *     <ul>
...
public class InternalUserController {
    ...
    public ResponseEntity<UserResponse> updateLanguage(
            @PathVariable Long userId,
            @RequestBody @Valid az.fitnest.identity.user.api.dto.request.UpdateLanguageRequest request) {
