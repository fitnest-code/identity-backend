...
public class MeController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> confirmEmailChange(@RequestParam String otpCode) {
        Long userId = UserContext.getRequiredUserId();
        User updated = userService.confirmEmailChange(userId, otpCode);
