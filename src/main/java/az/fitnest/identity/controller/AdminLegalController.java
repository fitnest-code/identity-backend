...
public class AdminLegalController {
    ...
    @Operation(summary = "List all legal documents", description = "Returns all legal documents with optional filtering.")
    ...
    @Operation(summary = "Get legal document by ID")
    ...
    @Operation(summary = "Update legal document")
    ...
    @Operation(summary = "Delete legal document")
    ...
    @Operation(summary = "Activate legal document")
    ...
    @Operation(summary = "Deactivate legal document")
    ...
    @GetMapping("/consents")
    @Operation(summary = "List user consents", description = "Returns paginated list of user consent records.")
